  ...
  async run(): Promise<void> {
    ...
    await providersRepo.save([
      providersRepo.create({
        legacy_id: 'PROV001',
        ruc: '20123456789',
        razon_social: 'MAQUINARIAS DEL PERÚ S.A.C.',
        nombre_comercial: 'Maquinarias Perú',
        tipo_proveedor: 'equipment',
      ...
      providersRepo.create({
        legacy_id: 'PROV002',
        ruc: '20987654321',
        razon_social: 'EQUIPOS PESADOS SAC',
        nombre_comercial: 'Equipos Pesados',
        tipo_proveedor: 'equipment',
    ...
    await equipmentRepo.save([
      equipmentRepo.create({
        ...
        marca: 'Caterpillar',
        modelo: '320D',
        numero_serie_equipo: 'CAT320D-2025-001',
      ...
      equipmentRepo.create({
        legacy_id: 'EQ002',
        codigo_equipo: 'TRA-001',
        categoria: 'TRACTOR',
        placa: 'DEF-456',
        marca: 'Komatsu',
        modelo: 'D65EX',
        numero_serie_equipo: 'KOM-D65-2025-001',
      ...
      equipmentRepo.create({
        legacy_id: 'EQ003',
        codigo_equipo: 'VOL-001',
        categoria: 'VOLQUETE',
        placa: 'GHI-789',
        marca: 'Volvo',
        modelo: 'FM500',
        numero_serie_equipo: 'VOL-FM500-2025-001',
        anio_fabricacion: 2022,
        estado: 'disponible',
        medidor_uso: 'ODOMETRO',
        is_active: true,
      }),
    ]);
