  ...
  async run(): Promise<void> {
    ...
    const trabajadoresData = [
      ...
      },
      {
        ...
        email: 'carlos.huaman@bitcorp.pe',
        cargo: 'Operador de Cargador Frontal',
        especialidad: 'Operación de cargadores y palas mecánicas',
        licenciaConducir: 'A-III-c',
        tipoContrato: 'PLAZO_FIJO',
      ...
      },
      {
        ...
        fechaNacimiento: new Date('1982-11-10'),
        telefono: '+51 987444555',
        email: 'miguel.condori@bitcorp.pe',
        cargo: 'Operador de Rodillo Compactador',
        especialidad: 'Compactación de suelos y pavimentos',
        licenciaConducir: 'A-III-b',
        tipoContrato: 'INDEFINIDO',
        fechaIngreso: new Date('2022-09-15'),
        isActive: true,
        tenantId: 1,
      },
      {
        ...
        fechaNacimiento: new Date('1991-07-04'),
        telefono: '+51 987555666',
        email: 'luis.flores@bitcorp.pe',
        cargo: 'Conductor de Volquete',
        especialidad: 'Transporte de materiales y agregados',
        licenciaConducir: 'A-III-c',
        tipoContrato: 'INDEFINIDO',
      ...
      },
      {
        ...
        fechaNacimiento: new Date('1987-09-18'),
        telefono: '+51 987666777',
        email: 'roberto.espinoza@bitcorp.pe',
        cargo: 'Conductor de Mixer',
        especialidad: 'Transporte y descarga de concreto premezclado',
        licenciaConducir: 'A-III-c',
        tipoContrato: 'PLAZO_FIJO',
      ...
      },
      {
        ...
        fechaNacimiento: new Date('1984-01-28'),
        telefono: '+51 987777888',
        email: 'fernando.chavez@bitcorp.pe',
        cargo: 'Operador de Grúa',
        especialidad: 'Izaje y maniobras con grúa telescópica',
        licenciaConducir: 'A-III-c',
        tipoContrato: 'INDEFINIDO',
      ...
      },
      {
        ...
        fechaNacimiento: new Date('1993-05-12'),
        telefono: '+51 987888999',
        email: 'andres.mendoza@bitcorp.pe',
        cargo: 'Técnico Electricista',
        especialidad: 'Instalaciones eléctricas y mantenimiento',
        licenciaConducir: 'A-II-b',
        tipoContrato: 'PLAZO_FIJO',
      ...
      },
      {
        ...
        apellidoMaterno: 'Ccahuantico',
        fechaNacimiento: new Date('1986-12-05'),
        telefono: '+51 987999000',
        email: 'raul.poma@bitcorp.pe',
        cargo: 'Operador de Retroexcavadora',
        especialidad: 'Excavación y zanjas con retroexcavadora',
        licenciaConducir: 'A-III-c',
        tipoContrato: 'INDEFINIDO',
      ...
      },
      {
        ...
        fechaNacimiento: new Date('1995-08-30'),
        telefono: '+51 987000111',
        email: 'jorge.quispe@bitcorp.pe',
        cargo: 'Conductor de Camioneta',
        especialidad: 'Transporte de personal y supervisión',
        licenciaConducir: 'A-II-b',
        tipoContrato: 'PLAZO_FIJO',
