...
test.describe('Daily Reports - Complete Workflow', () => {
  ...
  test('should list daily reports with data', async ({ page }) => {
    ...
    await expect(page.locator('.reports-container, .daily-report-list')).toBeVisible({ timeout: 15000 });
  ...
  test('should navigate to create new report', async ({ page }) => {
    ...
    const createButton = page.locator('button:has-text("Nuevo"), a:has-text("Nuevo"), button:has-text("Add")');
  ...
  test('should view report details', async ({ page }) => {
    ...
    const viewButton = page.locator('button[title="Ver"], button:has-text("Ver"), a[title="View"]').first();
...
test.describe('Daily Reports - Create Form', () => {
  ...
  test('should fill and save draft report', async ({ page }) => {
    ...
    // Save as draft
    const saveDraftButton = page.locator('button:has-text("Guardar Borrador"), button:has-text("Save Draft")');
...
test.describe('Daily Reports - Offline Indicator', () => {
  test('should show offline indicator when disconnected', async ({ page, context }) => {
    ...
    const offlineIndicator = page.locator('.offline-banner, .offline-indicator, [class*="offline"]');
