...
@Component({
  ...
  template: `
    <button 
      ...
      <span *ngIf="label || (loading && loadingText)">{{ loading && loadingText ? loadingText : label }}</span>
...
export class ButtonComponent {
  @Input() label = '';
  @Input() icon = '';
  @Input() variant: 'primary' | 'secondary' | 'danger' | 'success' | 'outline-primary' | 'outline-danger' | 'ghost' | 'icon' = 'primary';
