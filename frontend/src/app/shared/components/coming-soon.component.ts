    ...
    <div class="coming-soon-container">
      ...
      <div class="coming-soon-content">
        <div class="coming-soon-card">
          ...
          <p class="description">
            Estamos trabajando para traerte esta funcionalidad pronto. Por favor, vuelve a consultar
            más tarde.
          </p>
          <button class="btn-back" (click)="goBack()">← Volver al Panel de Control</button>
        </div>
      </div>
    </div>
  `,
