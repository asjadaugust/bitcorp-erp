          ...
          <div class="detail-main card">
            <div class="detail-header">
              <div>
                ...
                <p class="code-badge">{{ record.date | date:'dd/MM/yyyy' }}</p>
              </div>
            ...
            <div class="detail-sections">
              ...
              <section class="detail-section">
                ...
                <div class="info-grid">
                  <div class="info-item">
                    <label>Galones</label>
                    <p class="highlight">{{ record.gallons | number:'1.2-2' }}</p>
                  </div>
                  <div class="info-item">
                    <label>Costo por Galón</label>
                    <p>{{ record.cost_per_gallon | currency: 'PEN' : 'S/ ' }}</p>
                  </div>
                  <div class="info-item">
                    <label>Costo Total</label>
                    <p class="highlight">{{ record.total_cost | currency: 'PEN' : 'S/ ' }}</p>
                  </div>
                </div>
              </section>
              ...
              <section class="detail-section">
                ...
                <div class="info-grid">
                  <div class="info-item">
                    ...
                    <p>{{ record.hourmeter || '-' }} hrs</p>
                  </div>
                  <div class="info-item">
                    <label>Odómetro</label>
                    <p>{{ record.odometer || '-' }} km</p>
                  </div>
                </div>
              </section>
            </div>
