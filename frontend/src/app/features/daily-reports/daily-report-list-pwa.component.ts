  ...
  template: `
    <div class="daily-reports-pwa">
      ...
      <div class="page-header">
        ...
        <button class="btn btn-primary" routerLink="/daily-reports/new">+ Nuevo Reporte</button>
      </div>
      ...
      <div class="selection-bar" *ngIf="selectionMode()">
        ...
        <div class="selection-actions">
          ...
          <button class="btn btn-sm btn-secondary" (click)="cancelSelection()">Cancelar</button>
        </div>
      </div>

      <!-- Reports List -->
      <div class="reports-container">
        <div *ngIf="loading()" class="loading-spinner">Cargando reportes...</div>
      ...
      <button class="fab" routerLink="/daily-reports/new">+</button>
...
export class DailyReportListPWAComponent implements OnInit {
  ...
  filteredReports = computed(() => {
    ...
    if (this.filters.startDate) {
      result = result.filter((r) => r.fecha_parte >= this.filters.startDate);
    }
    if (this.filters.endDate) {
      result = result.filter((r) => r.fecha_parte <= this.filters.endDate);
    }
  ...
  private mergeReports(serverReports: any[], offlineReports: any[]): any[] {
    ...
    return merged.sort(
      (a, b) => new Date(b.fecha_parte).getTime() - new Date(a.fecha_parte).getTime()
    );
  }
