...
export const EQUIPMENT_TABS: TabItem[] = [
  ...
  {
    label: 'Observaciones',
    route: '/equipment/inspection-tracking',
    icon: 'fa-triangle-exclamation',
  },
];

export const OPERACIONES_TABS: TabItem[] = [
  ...
  { label: 'Contratos', route: '/equipment/operaciones/contratos', icon: 'fa-file-signature' },
];
