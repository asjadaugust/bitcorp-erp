...
@Component({
          ...
          <div class="equipment-list">
            <div *ngFor="let item of data.top_equipment" class="list-item">
              ...
              <div class="progress-bg">
                <div class="progress-bar" [style.width.%]="getEquipmentPercentage(item.total)"></div>
              </div>
            </div>
          </div>
        </div>
  ...
  styles: [`
    ...
    .summary-card.total .icon { background: var(--primary-100); color: var(--primary-500); }
    .summary-card.pending .icon { background: var(--semantic-yellow-100); color: var(--semantic-yellow-600); }
    .summary-card.approved .icon { background: var(--semantic-green-100); color: var(--semantic-green-600); }
    ...
    .status-draft { background: var(--grey-100); color: var(--grey-700); }
    .status-pending { background: var(--semantic-yellow-100); color: var(--semantic-yellow-700); }
    .status-approved { background: var(--semantic-green-100); color: var(--semantic-green-700); }
    .status-paid { background: var(--semantic-blue-100); color: var(--semantic-blue-700); }
