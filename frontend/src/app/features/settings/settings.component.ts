...
@Component({
            ...
            <div *ngIf="currentUser">
              <div class="form-grid">
                <div class="form-group">
                  ...
                  <input type="text" [value]="currentUser.username" readonly class="form-control readonly">
                </div>

                <div class="form-group">
                  <label>Email Corporativo</label>
                  <input type="email" [value]="currentUser.email" readonly class="form-control readonly">
                </div>

                <div class="form-group">
                  <label>Nombre</label>
                  <input type="text" [value]="currentUser.first_name" readonly class="form-control readonly">
                </div>

                <div class="form-group">
                  <label>Apellido</label>
                  <input type="text" [value]="currentUser.last_name" readonly class="form-control readonly">
                </div>
              </div>
            </div>
          </app-page-card>
  ...
  styles: [`
    ...
    .theme-preview.system { background: linear-gradient(135deg, #ffffff 50%, #1f2937 50%); }
