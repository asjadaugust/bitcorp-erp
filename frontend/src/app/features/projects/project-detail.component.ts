    ...
    <div class="detail-container">
      <div class="container">
              ...
              <section class="detail-section">
                ...
                <div class="info-grid">
                  ...
                  <div class="info-item">
                    ...
                    <p class="highlight">{{ project.presupuesto_total | currency: 'PEN' : 'S/ ' }}</p>
                  </div>
                </div>
              </section>
        ...
        <div *ngIf="!loading && !project" class="empty-state card">
          ...
          <button type="button" class="btn btn-primary" (click)="navigateTo('/projects')"> Volver a la lista
        </button>
        </div>
      </div>
    </div>
    ...
    <div *ngIf="showDeleteModal" class="modal" (click)="showDeleteModal = false">
      <div class="modal-content" (click)="$event.stopPropagation()">
        ...
        <div class="modal-body">
          <p>¿Estás seguro de que deseas eliminar el proyecto <strong>{{ project?.nombre }}</strong>?</p>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger" (click)="confirmDelete()"> Eliminar Proyecto
        </button>
        </div>
      </div>
    </div>
